...
* [Vulnerability assessment report template](vulnerability-assessment-report-template.docx)
...
In the **Remediation** section of the template, write **3-5 sentences** (60-100 words) summarising specific security controls that could be implemented to remediate or mitigate the risks to the information system.
