...
Use the following incident report template:

* incident-report-network-attack.docx

### Step 2: Access Supporting Materials

The following Wireshark TCP/HTTP log supporting materials will help you complete this activity. Keep them open as you proceed to the next steps.

* http-log.xlsx
* how-to-read-a-Wireshark-log.docx

### Step 3: Identify the type of attack causing the network interruption
