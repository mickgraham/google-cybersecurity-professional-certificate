...
This module covers how organizations protect themselves from threats, risks, and vulnerabilities.

### Security Frameworks and Controls

* Security frameworks and controls are important for organizing security efforts and making informed decisions.
* Continuous improvements to policies and procedures are necessary in the evolving field of security.
* The Confidentiality, Integrity, and Availability (CIA) triad is a foundational model in information security that guides an organization's policies and efforts to protect information assets.

### Ethics in Cybersecurity

* Ethics in cybersecurity refers to the moral principles that guide professional conduct and the responsible use of security technologies.
* It extends beyond legal requirements, emphasizing sound judgment in complex situations.
* Its core aim is to balance security needs with individual rights and broader societal values.
...
Counterattacks are actions taken against threat actors. They can lead to serious consequences, including escalation of attacks.
...
## Glossary: Protect Against Threats Risks and Vulnerabilities
