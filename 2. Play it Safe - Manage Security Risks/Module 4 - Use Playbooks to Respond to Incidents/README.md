...
* **Playbooks:** A playbook is a manual that provides details about any operational action
* **Six phases of incident response:**: An incident response is an organisation's quick attempt to identify an attack, aontain the damage, and correct the effects of a security breach
...
Common steps included in using playbooks to respond to incidents include:
...
## Glossary: Use Playbooks to Respond to Incidents
